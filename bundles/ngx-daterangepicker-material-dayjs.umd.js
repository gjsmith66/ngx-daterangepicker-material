(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('dayjs'), require('dayjs/plugin/localeData'), require('dayjs/plugin/localizedFormat'), require('dayjs/plugin/isoWeek')) :
    typeof define === 'function' && define.amd ? define('ngx-daterangepicker-material-dayjs', ['exports', '@angular/common', '@angular/core', '@angular/forms', 'dayjs', 'dayjs/plugin/localeData', 'dayjs/plugin/localizedFormat', 'dayjs/plugin/isoWeek'], factory) :
    (global = global || self, factory(global['ngx-daterangepicker-material-dayjs'] = {}, global.ng.common, global.ng.core, global.ng.forms, global.dayjs, global.localeData, global.LocalizedFormat, global.isoWeek));
}(this, (function (exports, common, core, forms, dayjs, localeData, LocalizedFormat, isoWeek) { 'use strict';
...
//# sourceMappingURL=ngx-daterangepicker-material-dayjs.umd.js.map
